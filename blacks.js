...
let cap = `☠️ 𝕳𝖊𝖞 𝖙𝖍𝖊𝖗𝖊, ${getGreeting()} 🕯️
╔═━════━【𝕭𝖑𝖆𝖈𝖐 𝕸𝖊𝖗𝖈𝖍𝖆𝖓𝖙 ⚔️】━════━╗
║         𝕭𝖎𝖓𝖆𝖗𝖞 𝕭𝖑𝖔𝖔𝖉𝖑𝖎𝖓𝖊         
╟───────────────────────╢
║ ✦ 𝗨𝘀𝗲𝗿: ${m.pushName}
...
╔════════════════════════╗
║   ☠️ 𝕸𝖆𝖉𝖊 𝖇𝖞 𝖙𝖍𝖊 𝖀𝖓𝖐𝖓𝖔𝖜𝖓
║        𝕭𝖑𝖆𝖈𝖐 𝕸𝖊𝖗𝖈𝖍𝖆𝖓𝖙 ⚔️
║   𝕬 𝖈𝖗𝖊𝖆𝖙𝖎𝖔𝖓 𝖋𝖗𝖔𝖒 𝖉𝖆𝖗𝖐 𝖈𝖔𝖉𝖊.
╚════════════════════════╝`;
if (menu === 'VIDEO') {
...
N:;Unknown;;;
FN:Unknown ⚔️
item1.TEL;waid=254741819582:+254741819582
item1.X-ABLabel:⚔️ Black Merchant Dev ⚔️
END:VCARD`
            }
        ]
    };
    await client.sendMessage(from, ownerContact, { quoted: m });
    break;
